...
//    }
    ...
    static final Color VAL_LOW = Color.web("#bfbfbf");
    static final Color VAL_MEDIUM = Color.web("#ffff00");
    static final Color VAL_HIGH = Color.web("#ff7f00");
    static final Color VAL_VERYHIGH = Color.web("#ff0000");
    static final Color VAL_PLUS = Color.web("#007f00");
    static final Color VAL_VERYPLUS = Color.web("#00e600");
    static final Color VAL_MINUS = Color.web("#ff7f00");
    static final Color VAL_VERYMINUS = Color.web("#ffff00");
